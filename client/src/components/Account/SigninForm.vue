<template>
  <div class="flex min-h-screen bg-background text-text">
    ...
    <div v-if="shouldShowIllustration" class="flex flex-1 items-center justify-center">
      <img src="@/assets/Signin-illustration.png" alt="Sign In Illustration" class="w-1/2" />
    </div>
    <div :class="formContainerClass">
      ...
      <div class="mt-2">
        <p class="text-secondary">
          Not using Sapientia yet?
          <span @click="goToSignUp" class="text-primary cursor-pointer">Sign up</span>
        </p>
      </div>
    </div>
  </div>
